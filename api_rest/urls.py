...
urlpatterns = [
    ...
    path('customers/delete-by-name/<str:name>/', views.deleteCustomerByName, name="delete_customer_by_name"),
    ...
    path('carts/<int:cart_id>/update/', views.updateCartStatus, name="update_cart_status"),
